...
FILE_NAME = "poland.md"
# FILE_NAME = "germany.md"
# FILE_NAME = "austria.md"

def generateHeader(file):
    file.write(f"# Ranking wspinaczy w roku {YEAR}\n")

def generateAscentMarkdown(climber, ascents):
    return True
...
def findInstagramProfile(name):
    ...
    for prof in search(query, num_results=1, sleep_interval=5):
        print(1)
        if 'instagram.com' in prof:
            profile = prof
            break
    return profile
...
def generatePerson(file, climber):
    ...
    file.write(f"## {climber[3]}. {climber[0]} ([TOP 10 najlepszych przejść]({ascent_file}))\n")
...
# url = "https://www.8a.nu/ranking/bouldering?country=germany"
# url = "https://www.8a.nu/ranking/bouldering?country=austria"
